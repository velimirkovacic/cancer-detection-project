...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\columnwidth]{ostalo/resnet50model.png}
		\caption{Korišteni model ResNet50}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\columnwidth]{ostalo/mobilenetv2model.png}
		\caption{Korišteni model MobileNetV2}
